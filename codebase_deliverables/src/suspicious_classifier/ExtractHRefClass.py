...
class ExtractHRef(object):
    ...
    def prep_data(self):
        ...
        fHandle.close()
        img_ext = ['.jpg','.gif','.png']
        sensitive_list=['name', 'address', 'card', 'telephone', 'age', 'routing number', 'account number', 'bank number', 'bank', 'social', 'security', 'beneficiary', 'compensation', 'opportunity', 'benefit', 'benefits', 'million', 'comission', 'commission']
        self.raw_data = lines
        for l in lines:
